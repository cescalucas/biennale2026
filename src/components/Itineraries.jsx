    ...
    <div>
      <section className="pt-12 pb-10 grid md:grid-cols-12 gap-6 hairline">
        <div className="md:col-span-8">
          <div className="label-tag terra-text">VIII · ROTEIROS</div>
      ...
      <section className="mt-10 grid md:grid-cols-12 gap-10">
        <div className="md:col-span-4">
          <div className="font-serif text-4xl italic ink-text leading-tight">{route.title}</div>
          ...
          <button onClick={() => setView('map')} className="mt-6 pillbtn px-4 py-2 text-[12px] uppercase tracking-widest border border-ink">
            Ver no mapa →
          </button>
        </div>
        <div className="md:col-span-8">
            ...
            {route.steps.map((s, i) => (
              <li key={i} className="grid grid-cols-12 gap-4 items-start">
                <div className="col-span-3 md:col-span-2 text-right">
                  <div className="font-serif text-2xl terra-text leading-none">{String(i + 1).padStart(2, '0')}</div>
                  <div className="label-tag muted-text mt-1">{s.time}</div>
                </div>
                <div className="col-span-9 md:col-span-10 hairline pb-6">
                  <div className="font-serif text-2xl ink-text leading-tight">{s.stop}</div>
